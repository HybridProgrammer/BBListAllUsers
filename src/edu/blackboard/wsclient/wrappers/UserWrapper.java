package edu.blackboard.wsclient.wrappers;
...
import com.blackboard.test.wsclient.wrappers.BaseClientWrapper;
...
public class UserWrapper extends BaseClientWrapper
{
     ...
     * @return an array of users  matching the UserFilter
     */
    public XMLStreamReader getStreamUser( UserFilter filter )
    {
        try
        {
            GetUser getUserParam = new GetUser();
            ...
            try {
                return _userWS.getUser( getUserParam ).getPullParser(new javax.xml.namespace.QName("http://user.ws.blackboard/"));
